...
Помни, что в день можно отправить *не больше 3 Kudos*. Кстати, самому себе Kudos тоже отправить нельзя :upside_down_face:`
    ...
    },
    {
        ...
        text: {
            type: 'mrkdwn',
            text: `Общий рейтинг по всем набранным Kudos можно посмотреть в статистике ниже. Сотрудники, набравшие наибольшее количество Kudos по каждой из шести категорий, по итогам месяца вознаграждаются приятными подарками с айдентикой Flawless Group!)
